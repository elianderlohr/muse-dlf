...
accelerate launch --multi_gpu --num_processes 4 --num_machines 1 --mixed_precision fp16 --config_file run/muse-dlf/train/accelerate_config.yaml src/train.py \
    --tags $TAGS \
    ...
    --path_name_bert_model models/roberta-base-finetune/roberta-base-finetune-2024-05-16_05-34-31-73594/checkpoint-32060 \
