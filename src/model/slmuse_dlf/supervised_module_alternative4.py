...
class SLMUSESupervisedAlternative4(nn.Module):
    def __init__(
        self,
        ...
        super(SLMUSESupervisedAlternative4, self).__init__()
        ...
        # First layer with BatchNorm, Activation, and Dropout
        layers.append(nn.Linear(input_dim, input_dim))
        layers.append(nn.BatchNorm1d(input_dim))
        layers.append(self.activation_first)
        layers.append(nn.Dropout(dropout_prob))

        # Output layers with BatchNorm, Activation, and Dropout
        layers.append(nn.Linear(input_dim, embedding_dim))
        layers.append(nn.BatchNorm1d(embedding_dim))
        layers.append(self.activation_last)
        layers.append(nn.Dropout(dropout_prob))
