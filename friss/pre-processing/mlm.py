...
class ModelArguments:
    ...
    cache_dir: Optional[str] = field(
        default=os.path.join(datasets_directory, "wikitext-2-raw", "cache"),
        metadata={
...
class DataTrainingArguments:
    ...
    train_data_file: Optional[str] = field(
        default=os.path.join(datasets_directory, "wikitext-2-raw", "wiki.train.raw"),
...
def main():
    ...
    logger.info(
        "training_args before intialization of the trainier:\n {}".format(training_args)
    )
